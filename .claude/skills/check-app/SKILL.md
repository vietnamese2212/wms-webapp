...
- ⭐ **ĐỒNG BỘ với phần còn lại của app (25/09, lớp C40):** soi riêng từng màn thì màn nào cũng "ổn" — Điều vận/Cước qua mọi phép kiểm mà user vẫn thấy ngay "nút action khác các giao diện khác". Đo **CÙNG một bộ tiêu chí trên MỌI trang menu** (kiểu nút chính đặc/viền · có Search/Views/density/FilterBar · vị trí tab so với hàng lọc · bảng `table-fixed` + tay kéo · nút trên dòng · chiều cao nút header · đường dẫn đầu trang) rồi lấy **SỐ ĐÔNG làm chuẩn**; màn lệch số đông mới là lỗi. Đo bằng `getComputedStyle` (màu nền nút, `table-layout`, `position` ô đầu) chứ đừng đọc code — khuôn dùng thật khác khuôn khai. Chuẩn đã chốt: skill `table-format` mục 22.
