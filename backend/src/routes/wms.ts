...
router.delete('/inbound-orders/:id/entries/:entryId',   requirePerm('inbound', 'delete'), inbound.removeEntry)
router.delete('/inbound-orders/:id/entries',            requirePerm('inbound', 'delete'), inbound.removeEntries)
