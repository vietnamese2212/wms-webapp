...
// STT chuẩn bị theo booking khung giờ — read-only, dùng ở list Xuất kho (view) + board Chuẩn bị hàng (prepare)
router.get('/outbound/booking-sequence',                      requireAnyPerm(['outbound', 'view'], ['outbound', 'prepare']), outbound.getBookingSequence)
