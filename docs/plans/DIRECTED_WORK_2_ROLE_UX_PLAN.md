...
> `separate_lowering_forklift`) · **Đợt C XONG** (user "Ok luôn đi"; migration 20260912g — RPC `work_inbox` +
> `directed_supervision`, tab "Hộp việc" 3 vùng, badge bottom-nav, khối Giám sát; C5 directed putaway vẫn để sau).
> Số đo lấy trên staging 12/09.
