...
export function useCreateWarehouse() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: (body: { code: string; name: string; address?: string; warehouse_type: string; inventory_mode?: string }) =>
...
export function useUpdateWarehouse() {
  const qc = useQueryClient()
  return useMutation({
    mutationFn: ({ id, ...body }: { id: string; name?: string; address?: string; is_active?: boolean; warehouse_type?: string; inventory_mode?: string }) =>
...
export function useUpdateMaterial() {
  ...
  return useMutation({
    mutationFn: ({ id, ...body }: {
      ...
      weight_kg?: number | null; cartons_per_pallet?: number | null
      units_per_carton?: number | null; shelf_life_days?: number | null
      is_active?: boolean; no_qr_tracking?: boolean
      warehouse_pallet_overrides?: import('@/types').WarehousePalletOverride[]
      supplier_shelf_life_overrides?: import('@/types').SupplierShelfLifeOverride[]
