...
import {
  ...
  ClipboardCheck, BarChart2, UserCog, ClipboardList, ShieldCheck, Tag, QrCode, Award, CalendarOff, CalendarRange,
} from 'lucide-react'
...
const navGroups: { label: string; items: { to: string; icon: React.ElementType; label: string; module?: ModuleKey; modules?: ModuleKey[]; adminOnly?: boolean }[] }[] = [
  ...
  },
  {
    label: 'Nhân sự (HR)',
    items: [
      { to: '/hr/skills',      icon: Award,         label: 'Vị trí & Skill', module: 'work_skill' },
