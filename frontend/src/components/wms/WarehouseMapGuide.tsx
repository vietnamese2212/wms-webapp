        ...
        {canEdit && (
          <Sec title="3 · Dựng bản vẽ lần đầu (máy tính)">
            <Steps items={[
              ...
              <><b>Số xe tối đa của cửa</b>: bấm cửa → pane → <b>Số xe tối đa cùng lúc</b> (mặc định 1, trống = không giới hạn) → <b>Áp</b>. Kho đã có cửa xuất trên bản vẽ thì chuyến <b>Bắt đầu</b> phải chọn cửa; cửa đủ xe thì xe sau chờ xe trước Hoàn thành (cùng biển số bốc thêm đơn không tính thêm xe). Chuyến sang kho nội bộ trực thuộc không cần cửa. Điểm đầu dãy khai <b>Pallet chờ tối đa</b> (0 = không giới hạn).</>,
