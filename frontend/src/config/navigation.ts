...
import {
  ...
  ArrowDownToLine, BellRing, NotebookPen, Move, Wallet, PackageSearch, ListChecks, CalendarClock, Store, Banknote, Waypoints,
} from 'lucide-react'
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Sơ đồ kho (bản vẽ 2D, 08/09) từ 21/09 là TAB của trang Vị trí kho (menu Cấu hình) — user: "bản vẽ là của
      // chính các vị trí". Nhóm "Bố trí kho" còn một mục nên trả về phẳng (không gom nhóm cho một mục).
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/tms/dispatch',      icon: Waypoints,     label: 'Điều vận',     module: 'dispatch' },
