...
export const MODULES = {
  ...
  outbound: {
    ...
    actions: {
      ...
      start:      'Bắt đầu',
      unstart:    'Gỡ bắt đầu',
      scan:       'Quét QR + Lưu thủ công hàng no-QR',
      ...
      weigh_waive: 'Duyệt bỏ qua cổng/cân — cho Bắt đầu khi xe chưa đăng ký cổng / không cân được (kho bật gate cân)',
    },
  },
  scanlog: {
    page: 'Lịch sử quét',
  ...
  inbound_plan: {
    ...
    tab:  'Kế hoạch nhập',
    actions: {
      // create/delete/cancel ĐÃ BỎ (mồ côi — không UI nào dùng; các thao tác đó đi theo
      // tms_plan.upload_inbound / tms_plan.edit). Chỉ giữ view + edit (TMS Report sửa PO).
      view:   'Xem kế hoạch nhập',
      edit:   'Sửa dòng kế hoạch (PO — TMS Report)',
    },
  },
  tms_vehicle_types: {
    page: 'Cài đặt TMS',
  ...
  gate_registration: {
    ...
    actions: {
      ...
      edit:   'Sửa thông tin',
      delete: 'Xóa đăng ký',
      call:   'Gọi xe + hoàn tác gọi (NV Kho)',
      entry:  'Xác nhận xe vào + hoàn tác (Bảo vệ)',
  ...
  materials: {
    ...
    actions: {
      view:   'Xem danh sách',
      create: 'Thêm mã hàng + Nhà sản xuất',
