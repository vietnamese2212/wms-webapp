...
function VehicleTypeDialog({ vt, open, onClose }: { vt: TmsVehicleType | null; open: boolean; onClose: () => void }) {
  ...
  function handleSubmit() {
    ...
    if (isEdit) {
      ...
      create({ code, name, ...dims }, { onSuccess: onClose, onError: e => setErr(apiMsg(e)) })
    }
  }
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1"><Label className="text-xs">Lòng thùng xe D×R×C (mm)</Label>
          <div className="flex items-center gap-1.5">
            ...
            <Input type="number" min={0} value={boxW} onChange={e => setBoxW(e.target.value)} placeholder="Rộng" />
            <span className="text-slate-400 text-xs">×</span>
